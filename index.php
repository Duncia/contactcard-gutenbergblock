...
class SilutesKcContactCards {
    ...
    -->
            ...
            <div class="fe-contact-card__position"><?php if(isset($attributes['jobPosition'])){echo esc_html($attributes['jobPosition']);}; ?></div>
            <div class="fe-contact-card__rest">
                ...
                <p>
                    <?php if(isset($attributes['phoneNumber'])){echo esc_html($attributes['phoneNumber']);}; ?>
                </p>
            </div>
            <div class="fe-contact-card__rest">
                ...
                <p>
                    <?php if(isset($attributes['emailAddress'])){echo esc_html($attributes['emailAddress']);}; ?>
                </p>
            </div>
        </div>
